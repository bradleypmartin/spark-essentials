# (Brad's fork of) The official repository for the Rock the JVM Spark Essentials with Scala course

This repository contains the code we wrote during  [Rock the JVM's Spark Essentials with Scala](https://rockthejvm.com/course/spark-essentials) (Udemy version [here](https://udemy.com/spark-essentials)) 

[_Brad's note: this is a fork of the official repo I'm tinkering with to follow along on my own with some exercises. Thanks, Daniel!_]
